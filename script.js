...
document.getElementById('start-btn')
    .addEventListener('click', startCreatingCards);
document.getElementById('save-btn')
    .addEventListener('click', saveFlashcards);
document.getElementById('prev-btn')
    .addEventListener('click', showPreviousCard);
...
function displayFlashcards() {
    ...
    flashcardDisplay.innerHTML =`
        ...
        document.getElementById('current-flashcard')
            .addEventListener('click', flipCurrentCard);
}
...
function flipCurrentCard() {
    ...
    // Toggle the 'flipped' class to triggerthe CSS animation
